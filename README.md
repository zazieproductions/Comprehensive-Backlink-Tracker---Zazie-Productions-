...
syndication and archival records. Research baseline through **2026-09-05**; user-submitted
additions through **2026-09-15**.

## The two deliverables (read these)

| PDF | What it is |
|---|---|
| **`Zazie_Master_Directory_COLOUR_CODED.pdf`** | The directory itself — 725 catalogued links in 14 colour-coded media-type sections, tier-ranked (A–D), every URL clickable, with per-category stats and the engine-endpoint appendix. |
...
data/master/        consolidated_directory.json (canonical: 725 records + 73 endpoints),
