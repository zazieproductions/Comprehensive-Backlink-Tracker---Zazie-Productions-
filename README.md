...
> [!TIP]
> ### 🧭 The 30-second map
> - **Just want to read the links?** → open 📕 [`Zazie_Master_Directory_COLOUR_CODED.pdf`](Zazie_Master_Directory_COLOUR_CODED.pdf) — 727 clickable links in 14 colour-coded sections.
