...
section('14', 'PROJECT-SECTION PASS — GROUPING THE CENSUS BY PROJECT', '#0b6e4f',
...
story.append(para('<b>14.1 — The role vocabulary</b> — how a link is described inside its project, and the order the groups '
...
story.append(para('<b>14.2 — Every project section, largest first</b> — the same table the master volume prints as PART I, '
...
story.append(para('<b>14.3 — Projects with a single catalogued link</b> — named in the register, but only one public page has '
...
story.append(para('<b>14.4 — What the pass deliberately does not do</b> — limits a reader should know before quoting any '
