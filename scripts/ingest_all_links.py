...
FLAG_RULES = [
    ...
    ('UNOFFICIAL FILM MIRROR', re.compile(r'(frenchstream\.tv|justwatch-hd|hdfilmcehennemi|openfilmzone|filmacorn|moview\.|pelis-api|thomas-spinec\.students|newtv\.co\.th|tvonlayn|stb\.hu|video\.link|chilimovie)', re.I),
    ...
    ('AUTO-GENERATED METADATA', re.compile(r'(hitplayer|chosic|gnoosic|songdata|sonichits|soundgasm|playlost|paroles-musique|zvu4no|gequbao|fangpi|musicstax|getmusic|muzvibe|x-minusovka|ligaudio|breakinghits|viberate|boomplay|163\.com|kkbox|anghami|douyin|ok\.ru|thirdeyemusic|lyricsplayground|muso\.ai|gaana\.com|flickchart\.com|rave\.dj)', re.I),
    ...
    ('AI ESSAY-MILL SAMPLE LIBRARY', re.compile(r'(samples\.eduwriter\.ai|eduwriter\.ai)', re.I),
     ...
     'advertising about the artist, not coverage of them', -20),
    ...
    ('SOCIAL / FORUM MENTION', re.compile(r'(reddit\.com|stevehoffman|mastodon|bsky|tumblr|facebook\.com|instagram\.com|(?<![a-z0-9])x\.com|twitter\.com|tiktok\.com)', re.I),
