...
FLAG_RULES = [
    ...
    ('AUTO-GENERATED METADATA', re.compile(r'(hitplayer|chosic|gnoosic|songdata|sonichits|soundgasm|playlost|paroles-musique|zvu4no|gequbao|fangpi|musicstax|getmusic|muzvibe|x-minusovka|ligaudio|breakinghits|viberate|boomplay|163\.com|kkbox|anghami|douyin|ok\.ru|thirdeyemusic|lyricsplayground|muso\.ai|rave\.dj)', re.I),
